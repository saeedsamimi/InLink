...
enum UserIdentity{
    ...
    BirthDate,
    Country,City,
    School,StartYear,EndYear,IsStudent,
    RecentJob,RecentCompany,EmploymentType
};
...
// if the active is true the user state will change to Activated othwise Added state will be considered!
